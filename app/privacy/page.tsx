    ...
    return (
        <div className="container mx-auto px-4 py-24 max-w-4xl">
            ...
            <div className="prose prose-invert prose-lg max-w-none">
                <p className="text-muted-foreground italic mb-12">Last updated: January 20, 2026</p>
                ...
                <section className="mb-12">
                    ...
                    <div className="bg-primary/10 border-l-4 border-primary p-6 rounded-r-xl my-6">
                ...
                <section className="mb-12">
                    <h2 className="text-2xl font-bold mb-4 text-primary">2. Data Collection and Usage</h2>

                    <h3 className="text-xl font-semibold mb-2">No Remote Data Collection</h3>
                    <p>
                    ...
                    <p className="mt-4 italic">This data never leaves your browser instance and is not accessible to R2DSolutions.</p>
                </section>

                <section className="mb-12">
                    <h2 className="text-2xl font-bold mb-4 text-primary">3. Permissions Usage</h2>
                    <p className="mb-8">Each extension requires specific permissions to perform its core functions. We only request the minimum permissions necessary.</p>
                ...
                <section className="mb-12">
                    <h2 className="text-2xl font-bold mb-4 text-primary">4. User Rights</h2>
                    <p>
                ...
                <section className="mb-12">
                    <h2 className="text-2xl font-bold mb-4 text-primary">5. Contact</h2>
                    <p>
